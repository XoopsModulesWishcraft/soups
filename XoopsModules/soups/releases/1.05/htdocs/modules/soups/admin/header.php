...
IF (!@ include_once XOOPS_ROOT_PATH . "/Frameworks/art/functions.index.php"):    
...
function loadModuleAdminMenu($currentoption, $breadcrumb = "")
{
    ...
    $adminmenu_text .= '<li><a href="' . XOOPS_URL . '/modules/system/index.php?fct=preferences&op=showmod&mod=' . $GLOBALS["xoopsModule"]->getVar("mid") . '"><span>' . _PREFERENCES . '</span></a></li>';
    $adminmenu_text .= '
     </ul>
    </div>
    <br style="clear:both;" />';
